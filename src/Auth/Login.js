            ...
            <div className="container d-flex mt-4 justify-content-center">
                ...
                <fieldset>
                    ...
                    <div className='p-2 position-relative'>
                        <input className='p-2 form-control text-center rounded' type={type} onChange={(e) => setPassword(e.target.value)} value={password} name="password" placeholder="password"/>
