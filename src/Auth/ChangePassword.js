        ...
        <div className="container d-flex mt-3 justify-content-center">
            ...
            <fieldset>
                ...
                <div className='p-2 position-relative'>
                    <input className='p-2 rounded form-control text-center' type={passwordType.oldPassword} onChange={(e) => setOldPassword(e.target.value)} value={old_password} name="old_password" placeholder="old_password"/>
                ...
                <div className='p-2 position-relative'>
                    <input className='p-2 form-control text-center rounded' type={passwordType.newPassword1} onChange={(e) => setNewPassword(e.target.value)} value={new_password1} name="new_password1" placeholder="new_password1"/>
                ...
                <div className='p-2 position-relative'>
                    <input className='p-2 form-control text-center rounded' type={passwordType.newPassword2} onChange={(e) => setNewPassword2(e.target.value)} value={new_password2} name="new_password2" placeholder="new_password2"/>
