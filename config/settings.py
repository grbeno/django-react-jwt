...
DOMAIN_NAME = env.str('DOMAIN_NAME', default='')
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'accounts.validators.UppercaseAndNumericPasswordValidator',  # custom password validator
    },
]
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(minutes=90),  # days=1
    ...
    "AUTH_HEADER_TYPES": ("Bearer", "JWT"),  # JWT added
...
DJANGO_REST_MULTITOKENAUTH_RESET_TOKEN_EXPIRY_TIME = 3600  # 1 hour
